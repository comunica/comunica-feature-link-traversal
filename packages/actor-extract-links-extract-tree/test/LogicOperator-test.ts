...
describe('LogicOperator', () => {
  ...
  describe('And', () => {
    ...
    describe('apply', () => {
      ...
      it('Given a domain and two ranges to add that are not overlapping and where those two interval don\'t overlap with the domain should return the initial domain', () => {
      ...
      it('Given a domain and two ranges to add that not overlapping and where the first one is overlap with the domain then should return a new valid domain', () => {
      ...
      it('Given a domain and two ranges to add that not overlapping and where the second one is overlap with the domain then should return a new valid domain', () => {
      ...
      it('Given a domain and two ranges to add that not overlapping and where the both are overlap and the first one is more overlapping than the second with the domain then should return a new valid domain', () => {
