...
import { ActorExtractLinksShapetrees } from '../lib/ActorExtractLinksShapetrees';
import { ShapeTree } from '../lib/ShapeTree';

const DF = new DataFactory();
const BF = new BindingsFactory();

describe('ActorExtractLinksShapetrees', () => {
  let bus: any;
  ...
  describe('An ActorExtractLinksShapetrees instance', () => {
    let actor: ActorExtractLinksShapetrees;
...
`,
      ...
      actorInitQuery = <any> {};
      actor = new ActorExtractLinksShapetrees({
        name: 'actor',
        bus,
    ...
    describe('run', () => {
      it('should run', () => {
        return expect(actor.run(<any> { todo: true })).resolves.toMatchObject({ links: []});
      });
    });
  });
});
